...
<body>
    ...
    <div class="section">
        ...
        <table>
            ...
            <tr>
                <td><span class="cmd">:bm add [tags]</span></td>
                <td>Bookmark current page with optional comma-separated tags</td>
            </tr>
            <tr>
                <td><span class="cmd">:bm list</span></td>
                <td>Show all bookmarks</td>
            </tr>
            <tr>
                <td><span class="cmd">:bm search &lt;query&gt;</span></td>
                <td>Search bookmarks by title, URL, content, or tags</td>
            </tr>
            <tr>
                <td><span class="cmd">:bm del &lt;id&gt;</span></td>
                <td>Delete bookmark by ID</td>
            </tr>
            <tr>
                <td><span class="cmd">:bm tags</span></td>
                <td>Show all bookmark tags</td>
            </tr>
        </table>
    </div>
